...
def kde_prep():
    ...
    is_2d, name_col, x_col, y_col, z_col = get_params(names)
    
    # r = robjects.r
    # r['source']('C:/Users/Kevin/Documents/GitHub/Zoo-Mapper/src/rscripts/3D_KDE_2021.R')
    
    subprocess.call(['Rscript', 'C:/Users/Kevin/Documents/GitHub/Zoo-Mapper/src/rscripts/3D_KDE_2021.R', filename, is_2d, name_col, x_col, y_col, z_col])

    # subprocess.call(['Rscript', 'C:/Users/Kevin/Documents/GitHub/Zoo-Mapper/src/rscripts/test.R', 'hello'])

## other options: noise, range of noise, 
