...
class General_Moon_Scrape_Page(tk.Frame):
    """
...
class StartPage(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        button7.grid(row=3, column=0, sticky=N)
        # temp got rid of button3
        buttons = {button1, button2, button4, button5, button6, button7}
